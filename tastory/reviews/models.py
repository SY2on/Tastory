...
class Review(models.Model):
    ...
    user_id = models.ForeignKey('users.User', on_delete=models.SET_NULL, db_column="user_id", null=True)
    ...
    status = models.CharField(max_length=7, help_text="Review status", choices=STAT_CHOICE, default='PUBLIC')
...
class ReviewImg(models.Model):
    ...
    status = models.CharField(max_length=7, help_text="Review_img status", choices=STAT_CHOICE, default='ACTIVE')
...
class UserReviewLike(models.Model):
    ...
    status = models.CharField(max_length=7, help_text="좋아요 활성화 active/deleted", choices=STAT_CHOICE, default='ACTIVE')
...
class UserReviewScrap(models.Model):
    ...
    status = models.CharField(max_length=7, help_text="스크랩 활성화 active/deleted", choices=STAT_CHOICE, default='ACTIVE')
...
class Comment(models.Model) :
    ...
    user_id = models.ForeignKey("users.User", related_name="user", on_delete=models.SET_NULL, db_column="user_id", null=True)
    ...
    status = models.CharField(max_length=7, choices=STAT_CHOICE, default='ACTIVE')
